...
제거합니다. 플러그인에 포함된 스킬은 관리하지 않습니다. `activate` 결과는
`deployed`로 기록하며 호스트의 별도 활성·비활성 설정까지 켜졌다고 단정하지
않습니다.
...
- 외부 원본 보관함은 읽기 전용입니다. 쓰기는 Stash 관리형 보관소와
  명시적으로 선택한 독립 스킬 생명주기 대상에만 허용합니다.
